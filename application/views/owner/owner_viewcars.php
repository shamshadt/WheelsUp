...
<body>
																				...
																				<?php
																			  		if(!$list)
																			  		{
																			  			echo '<div  style="padding-top: 9%; padding-left: 	5%" >';
																			  			echo '<center><h1 style="font-family:Times New Roman, Times, serif;font-size:36px;color:#FF0000" >No Cars Approved...!!</h1></center>';
																			  			echo '</div>';
																			  		}
																			  		else
																			  		{
        ...
        <h5>   <font color="green"><?php echo $this->session->flashdata('Update_sucess');  ?> </font></h5>
			...
			<!-- <div  style="padding-left: 15%" > -->
				<div class="dashboard-list-box" style="width: 98%; padding-left:5%; padding-top:3%;">
		                ...
		                <center> <h5>   <font size="5px" color="red"><?php echo $this->session->flashdata('Unavailiable');  ?> </font></h5>  </center>
							...
							<table   style="background-color:#fffffff" >
																				...
																				?>
																					...
																					<form action="<?php echo site_url('ownercontroller/carsviewchange')?>" method="post" name="userlist">
																					<tr>
