                            ...
                            <div class="dashboard_container">
                                    ...
                                    <nav class="navbar navbar-default navbar-fixed-top">
                                        <div class="container">
                                           <div class="navbar-header">
                                            <div class="logo"> <a href="index.html"><img src="<?php  echo base_url('assets/adminimages/logo.png')?>" alt="image"/></a> </div>
                                                ...
                                                <div class="user_nav">
                                                    <div class="dropdown">
                                                      <span id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        ...
                                                        <img src="<?php  echo base_url('assets/adminimages/happy-client-01.jpg ')?>" alt="image"/>
                                                      </span>
                                ...
                                <div id="dashboard-nav" class="dashboard-nav">  
                                    <ul>
                                        ...
                                        <li><a href="<?php echo site_url('controller/expand')?>"><i class="fa fa-power-off"></i> Approval</a></li>
                                        ...
                                        <li> <a href="<?php echo site_url('controller/adminprofile')?>" > <i class="fa fa-user-o"></i> My Profile</a></li>
                                ...
                                <div class="dashboard-content">
                                    ...
                                    <div id="titlebar">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2>Dashboard</h2>  <h1> hai adddmin</h1>
                                                <!-- Breadcrumbs -->
                                                <nav id="breadcrumbs">
                                                    <ul>
                                                        <li><a href="#">Home</a></li>
