                ...
                <div class="container">
                    <div id="category_slider">
                        <div class="owl-carousel owl-theme">
                              ...
                              <div class="item">
                                <a href="<?php echo site_url('drivercontroller/profile')?>">
                                  <div class="category_icon">
                                          <img src="<?php echo base_url('assets/driver/images/active.png'); ?> " alt="image">
                              ...
                              <!-- <div class="item">
                                <a href="<?php echo site_url('drivercontroller/view_requests')?>">
                                  <div class="category_icon">
                                          <img src="<?php echo base_url('assets/driver/images/requests.png'); ?> " alt="image">
