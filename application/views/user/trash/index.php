...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/user/css/animate.css" type="text/css')?>">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/user/css/datepicker.css" type="text/css')?>">
  ...
  <!--[if lt IE 9]>
    ...
    <!-- Fav and touch icons -->
    <a href="#"><img src="<?php echo base_url('assets/img/wheel.png'); ?>" alt="" title="" /></a>
  ...
  <!-- Header end -->
    ...
    <section id="teaser">
      <div class="container">
        ...
        <script src="<?php echo base_url('assets/user/js/jquery.autocomplete.min.js')?>"></script>
        <script src="<?php echo base_url('assets/user/js/jquery.placeholder.js')?>"></script>
        <script src="<?php echo base_url('assets/user/js/locations-autocomplete.js')?>"></script>
        <script src="<?php echo base_url('assets/user/js/bootstrap-datepicker.js')?>"></script>
        <script src="<?php echo base_url('assets/user/js/gmap3.min.js')?>"></script>
