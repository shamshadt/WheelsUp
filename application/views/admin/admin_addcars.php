...
function dist()
{
  ...
  $.ajax({
    method:'post',
    url:"<?php echo site_url("controller/districtselect"); ?>",
    processData: false,
    contentType: false,
    data: data,
...
function places()
{
  ...
  $.ajax({
    method:'post',
    url:"<?php echo site_url("controller/placeselect"); ?>",
    processData: false,
    contentType: false,
    data: data,
    success:function(result){
                                            										...
                                            										<div class="col-md-6" style="background:#bdcece">
                                            											...
                                            											<div >
                                                                                                ...
                                                                                                <h5>   <font color="red"><?php echo $this->session->flashdata('regno_exist');  ?> </font></h5>
                                            															<h3 style="padding-left: 15%">Add New Cars</h3> 
                                            													
                                            													
                                            													<form action="<?php echo site_url('controller/adminaddcars')?>" method="post" name="driverlist" enctype="multipart/form-data">
                                            														...
                                            														<div class="form">
                                            																...
                                            																<p>
                                            																	...
                                            																	<input type="text" class="field size1" name="day_rate" required />
                                            																</p>
                                            																<p>
                                            																			
                                            																	<label>Security Deposit<span>(Required Field)</span></label>
                                            																	<input type="text" class="field size1" name="sec_deposit" required />
                                            																</p>
                                            																<p>
                                            																			
                                            																	<label>Vehicle Image <span>(Required Field)</span></label>
                                            																	<input type="file" class="field size1" name="carimage" required accept=".png, .jpg, .jpeg,.JPG" />
                                            																</p>
                                            																<p>
                                                                                                             ...
                                                                                                             <p>
                                                                                                                ...
                                                                                                                <input type="text" class="field size1" name="regno" required />
                                                                                                            </p> 
    ...
    <div class="row" >
        ...
        <div class="col-sm-9"  style="  background: #ffffff"  >
          ...
          <div class="tab-content">
                  ...
                  <form   action="<?php echo site_url('controller/adminaddcars')?>" enctype="multipart/form-data"  class="cv-form" method="post" onsubmit="return">
                    ...
                    <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input  type="text" class="cv-vehicle_number form-control"  name="regno" id="regno" value="" placeholder="Reg No (Eg: KL50B2715)"  onkeyup="this.value = this.value.toUpperCase();">
                         <div id=p1></div>
                            </div>
                      </div>
    ...
    <div class="row" >
        ...
        <div class="col-sm-9"  style="  background: #ffffff"  >
          ...
          <div class="tab-content">
                  ...
                  <form   action="<?php echo site_url('controller/adminupdatecars')?>" enctype="multipart/form-data" method="post"  onSubmit="return" class="oh-autoval-form">
