  ...
  transform: scale(3); 
                         ...
                         <!-- Content -->
                                        <div class="dashboard-content">
                                                                ...
                                                                <H4 align="center"> <u><b> Registered Drivers  </b></u> </H1>
                                                                ...
                                                                <?php
                                                                    if(!$driver)
                                                                    {
                                                                        echo '<center><h1 style="font-family:Times New Roman, Times, serif;font-size:25px;color:#FF0000; margin-top:5%;" >No Registered Drivers...!!</h1></center>';
                                                                    }
                                                                    else
                                                                    {
                                                                ?>
                                                    ...
                                                    <div align="center" style="font-size:18px;color:#000000;width:100%;height:auto; margin-top: 5%" >
                                                            ...
                                                            foreach($driver as $row)
                                                                        ...
                                                                        ?>
                                                            <form action="<?php echo site_url('controller/blockdriveraction')?>" method="post" name="userlist">
                                                            <tr>
